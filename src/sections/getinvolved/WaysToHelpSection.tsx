...
export default function WaysToHelpSection() {
  ...
  const toggleUseGoogleForms = (val: boolean) => {
    setUseGoogleForms(val);
    localStorage.setItem('lifora_use_google_forms', String(val));
  };
            ...
            >
              ...
              <div className="lg:col-span-5 w-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl relative overflow-hidden flex flex-col min-h-[650px]">
                  ...
                  <div className="mb-4">
                    <h3 className="text-2xl font-bold text-mao-dark text-left">Volunteer Application</h3>
